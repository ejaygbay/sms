...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="#">Home 1</a></li>
            <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Docs 2</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Community 3</a></li>
            <li class="menu-item hidden"><a
                    href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/CONTRIBUTING.md" target="_blank">Contribute 4</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to SMS CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
